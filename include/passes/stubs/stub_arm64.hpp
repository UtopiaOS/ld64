...
namespace arm64
{
		...
		public:
			ImageCachePointerAtom(ld::passes::stubs::Pass &pass)
				: ld::Atom(_s_section, ld::Atom::definitionRegular, ld::Atom::combineNever,
				           ...
				           symbolTableIn, false, false, false, ld::Atom::Alignment(3))
			{
				pass.addAtom(*this);
			}
	...
	class LazyPointerAtom : public ld::Atom
	{
		...
		private:
			static ld::Section &
			selectSection(bool stubToGlobalWeakDef, bool stubToResolver, bool dataConstUsed)
			{
