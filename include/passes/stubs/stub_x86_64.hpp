		...
		public:
			StubAtom(ld::passes::stubs::Pass &pass, const ld::Atom &stubTo,
				...
				: ld::Atom(_s_section, ld::Atom::definitionRegular, ld::Atom::combineNever,
				  ...
				  _fixup(2, ld::Fixup::k1of1, ld::Fixup::kindStoreTargetAddressX86PCRel32, &_lazyPointer)
			{
				pass.addAtom(*this);
			}
		...
		public:
			NonLazyStubAtom(ld::passes::stubs::Pass &pass, const ld::Atom &stubTo,
				...
				: ld::Atom(_s_section, ld::Atom::definitionRegular, ld::Atom::combineNever,
				  ...
				  _fixup(2, ld::Fixup::k1of1, ld::Fixup::kindStoreTargetAddressX86PCRel32, &_nonLazyPointer)
			{
				pass.addAtom(*this);
			}
