...
namespace x86
{
		...
		public:
			ImageCachePointerAtom(ld::passes::stubs::Pass &pass)
				: ld::Atom(_s_section, ld::Atom::definitionRegular, ld::Atom::combineNever,
				           ...
				           symbolTableIn, false, false, false, ld::Atom::Alignment(2))
			{
				pass.addAtom(*this);
			}
	...
	class StubHelperHelperAtom : public ld::Atom
	{
		...
		private:
			static ld::Atom *
			compressedImageCache(ld::passes::stubs::Pass &pass)
			{
			...
			static ld::Atom *
			compressedFastBinder(ld::passes::stubs::Pass &pass)
			{
		...
		public:
			StubHelperAtom(ld::passes::stubs::Pass &pass, const ld::Atom *lazyPointer,
				...
				: ld::Atom(_s_section, ld::Atom::definitionRegular, ld::Atom::combineNever,
				  ...
				  _fixup3(6, ld::Fixup::k1of1, ld::Fixup::kindStoreTargetAddressX86BranchPCRel32, helperHelper(pass, *this,
				          stubToResolver)) { }
			...
			fixupsEnd() const
			{
				return &((ld::Fixup *)&_fixup3)[1];
			}

		private:
			static ld::Atom *
			helperHelper(ld::passes::stubs::Pass &pass, StubHelperAtom &stub, bool stubToResolver)
			{
		...
		public:
			StubAtom(ld::passes::stubs::Pass &pass, const ld::Atom &stubTo,
				...
				: ld::Atom(_s_section, ld::Atom::definitionRegular, ld::Atom::combineNever,
				  ...
				  _fixup(2, ld::Fixup::k1of1, ld::Fixup::kindStoreTargetAddressLittleEndian32, &_lazyPointer)
			{
				pass.addAtom(*this);
			}
		...
		public:
			NonLazyPointerAtom(ld::passes::stubs::Pass &pass, const ld::Atom &target,
				...
				: ld::Atom(_s_section, ld::Atom::definitionRegular,
				  ...
				  _fixup1(0, ld::Fixup::k1of1, ld::Fixup::kindStoreTargetAddressLittleEndian32,
				          (stubToResolver ? & _resolverHelper : & target))
			{
