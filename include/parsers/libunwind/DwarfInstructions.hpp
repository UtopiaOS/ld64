...
namespace libunwind
{
	...
	template <typename A, typename R>
	const char *
	DwarfInstructions<A, R>::parseCFIs(A &addressSpace, pint_t ehSectionStart, uint32_t sectionLength,
	                                   const pint_t cuStarts[], uint32_t cuCount,
	                                   bool keepDwarfWhichHasCU,  bool forceDwarfConversion, bool neverConvertToCU,
	                                   CFI_Atom_Info<A> *infos, uint32_t &infosCount, void *ref, WarnFunc warn)
	{
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						{
							char warningBuffer[1024];
							entry->u.fdeInfo.compactUnwindInfo = createCompactEncodingFromProlog(addressSpace, fdeInfo.pcStart, dummy, prolog,
							                                     warningBuffer);
	...
	DwarfInstructions<A, R>::createCompactEncodingFromFDE(A &addressSpace, pint_t fdeStart,
	        pint_t *lsda, pint_t *personality,
	        char warningBuffer[1024])
	{
		typename CFI_Parser<A>::FDE_Info fdeInfo;
	...
	template <typename A, typename R>
	typename A::pint_t
	DwarfInstructions<A, R>::getSavedRegister(A &addressSpace, const R &registers, pint_t cfa,
	        const typename CFI_Parser<A>::RegisterLocation &savedReg)
	{
	...
	template <typename A, typename R>
	double
	DwarfInstructions<A, R>::getSavedFloatRegister(A &addressSpace, const R &registers, pint_t cfa,
	        const typename CFI_Parser<A>::RegisterLocation &savedReg)
	{
		switch (savedReg.location)
		{
	...
	template <typename A, typename R>
	v128
	DwarfInstructions<A, R>::getSavedVectorRegister(A &addressSpace, const R &registers, pint_t cfa,
	        const typename CFI_Parser<A>::RegisterLocation &savedReg)
	{
		switch (savedReg.location)
		{
	...
	template <typename A, typename R>
	int
	DwarfInstructions<A, R>::stepWithDwarf(A &addressSpace, pint_t pc, pint_t fdeStart, R &registers)
	{
	...
	template <typename A, typename R>
	int
	DwarfInstructions<A, R>::lastRestoreReg(const Registers_x86_64 &)
	{
	...
	template <typename A, typename R>
	bool
	DwarfInstructions<A, R>::isReturnAddressRegister(int regNum, const Registers_x86_64 &)
	{
	...
	template <typename A, typename R>
	typename A::pint_t
	DwarfInstructions<A, R>::getCFA(A &addressSpace, const typename CFI_Parser<A>::PrologInfo &prolog,
	...
	template <typename A, typename R>
	compact_unwind_encoding_t
	DwarfInstructions<A, R>::encodeToUseDwarf(const Registers_x86_64 &)
	{
	...
	template <typename A, typename R>
	compact_unwind_encoding_t
	DwarfInstructions<A, R>::encodeToUseDwarf(const Registers_x86 &)
	{
	...
	template <typename A, typename R>
	uint32_t
	DwarfInstructions<A, R>::getRBPEncodedRegister(uint32_t reg, int32_t regOffsetFromBaseOffset, bool &failure)
	{
	...
	template <typename A, typename R>
	compact_unwind_encoding_t
	DwarfInstructions<A, R>::createCompactEncodingFromProlog(A &addressSpace, pint_t funcAddr,
	...
	template <typename A, typename R>
	int
	DwarfInstructions<A, R>::lastRestoreReg(const Registers_x86 &)
	{
	...
	template <typename A, typename R>
	bool
	DwarfInstructions<A, R>::isReturnAddressRegister(int regNum, const Registers_x86 &)
	{
	...
	template <typename A, typename R>
	uint32_t
	DwarfInstructions<A, R>::getEBPEncodedRegister(uint32_t reg, int32_t regOffsetFromBaseOffset, bool &failure)
	{
	...
	template <typename A, typename R>
	int
	DwarfInstructions<A, R>::lastRestoreReg(const Registers_ppc &)
	{
	...
	template <typename A, typename R>
	bool
	DwarfInstructions<A, R>::isReturnAddressRegister(int regNum, const Registers_ppc &)
	{
	...
	template <typename A, typename R>
	compact_unwind_encoding_t
	DwarfInstructions<A, R>::encodeToUseDwarf(const Registers_arm64 &)
	{
	...
	template <typename A, typename R>
	bool
	DwarfInstructions<A, R>::isReturnAddressRegister(int regNum, const Registers_arm64 &)
	{
	...
	template <typename A, typename R>
	int
	DwarfInstructions<A, R>::lastRestoreReg(const Registers_arm64 &)
	{
	...
	template <typename A, typename R>
	bool
	DwarfInstructions<A, R>::checkRegisterPair(uint32_t reg, const typename CFI_Parser<A>::PrologInfo &prolog,
	        int &offset, char warningBuffer[1024])
	{
	        ...
	        char warningBuffer[1024])
	{
		...
		if (standardFrameless)
		{
			...
			const int32_t maxStack = (UNWIND_ARM64_FRAMELESS_STACK_SIZE_MASK >> __builtin_ctz(
			...
			encoding = UNWIND_ARM64_MODE_FRAMELESS | ((prolog.cfaRegisterOffset / 16) << __builtin_ctz(
			               UNWIND_ARM64_FRAMELESS_STACK_SIZE_MASK));
			offset = -16;
		}
	...
	template <typename A, typename R>
	compact_unwind_encoding_t
	DwarfInstructions<A, R>::encodeToUseDwarf(const Registers_arm &)
	{
