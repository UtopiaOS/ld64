...
namespace libunwind
{
	...
	class Registers_x86
	{
		public:
			...
			bool
			validFloatRegister(int num) const
			{
				return false;
			}
			...
			bool
			validVectorRegister(int num) const
			{
				return false;
			}
	...
	inline
	Registers_x86::Registers_x86(const void *registers)
	{
	...
	inline bool
	Registers_x86::validRegister(int regNum) const
	{
	...
	inline uint32_t
	Registers_x86::getRegister(int regNum) const
	{
		switch (regNum)
		{
			case UNW_REG_IP:
	...
	inline void
	Registers_x86::setRegister(int regNum, uint32_t value)
	{
		switch (regNum)
		{
			case UNW_REG_IP:
	...
	inline const char *
	Registers_x86::getRegisterName(int regNum)
	{
		switch (regNum)
		{
			case UNW_REG_IP:
	...
	inline double
	Registers_x86::getFloatRegister(int num) const
	{
		ABORT("no x86 float registers");
	}

	inline void
	Registers_x86::setFloatRegister(int num, double value)
	{
		ABORT("no x86 float registers");
	}

	inline v128
	Registers_x86::getVectorRegister(int num) const
	{
		ABORT("no x86 vector registers");
	}

	inline void
	Registers_x86::setVectorRegister(int num, v128 value)
	{
		ABORT("no x86 vector registers");
	}
	...
	inline
	Registers_x86_64::Registers_x86_64(const void *registers)
	{
	...
	inline bool
	Registers_x86_64::validRegister(int regNum) const
	{
		if (regNum == UNW_REG_IP)
		{
			return true;
	...
	inline uint64_t
	Registers_x86_64::getRegister(int regNum) const
	{
		switch (regNum)
		{
			case UNW_REG_IP:
	...
	inline void
	Registers_x86_64::setRegister(int regNum, uint64_t value)
	{
		switch (regNum)
		{
			case UNW_REG_IP:
	...
	inline const char *
	Registers_x86_64::getRegisterName(int regNum)
	{
		switch (regNum)
		{
			case UNW_REG_IP:
	...
	double
	Registers_x86_64::getFloatRegister(int num) const
	{
		ABORT("no x86_64 float registers");
	}

	void
	Registers_x86_64::setFloatRegister(int num, double value)
	{
		ABORT("no x86_64 float registers");
	}

	inline v128
	Registers_x86_64::getVectorRegister(int num) const
	{
		ABORT("no x86_64 vector registers");
	}

	inline void
	Registers_x86_64::setVectorRegister(int num, v128 value)
	{
		ABORT("no x86_64 vector registers");
	}
	...
	inline
	Registers_ppc::Registers_ppc(const void *registers)
	{
	...
	inline bool
	Registers_ppc::validRegister(int regNum) const
	{
		if (regNum == UNW_REG_IP)
		{
			return true;
	...
	inline uint32_t
	Registers_ppc::getRegister(int regNum) const
	{
		switch (regNum)
		{
			case UNW_REG_IP:
	...
	inline void
	Registers_ppc::setRegister(int regNum, uint32_t value)
	{
	...
	inline bool
	Registers_ppc::validFloatRegister(int regNum) const
	{
	...
	inline double
	Registers_ppc::getFloatRegister(int regNum) const
	{
	...
	inline void
	Registers_ppc::setFloatRegister(int regNum, double value)
	{
	...
	inline bool
	Registers_ppc::validVectorRegister(int regNum) const
	{
	...
	v128
	Registers_ppc::getVectorRegister(int regNum) const
	{
	...
	void
	Registers_ppc::setVectorRegister(int regNum, v128 value)
	{
		assert(validVectorRegister(regNum));
	...
	inline const char *
	Registers_ppc::getRegisterName(int regNum)
	{
		switch (regNum)
		{
			case UNW_REG_IP:
	...
	class Registers_arm64
	{
		public:
			...
			getFP() const
			{
				return fRegisters.__fp;
			}
			void
			setFP(uint64_t value)
			{
				fRegisters.__fp = value;
			}
		private:
	...
	inline
	Registers_arm64::Registers_arm64(const void *registers)
	{
	...
	inline bool
	Registers_arm64::validRegister(int regNum) const
	{
		if (regNum == UNW_REG_IP)
		{
			return true;
	...
	inline uint64_t
	Registers_arm64::getRegister(int regNum) const
	{
		if (regNum == UNW_REG_IP)
		{
			return fRegisters.__pc;
	...
	inline void
	Registers_arm64::setRegister(int regNum, uint64_t value)
	{
		if (regNum == UNW_REG_IP)
		{
			fRegisters.__pc = value;
	...
	inline const char *
	Registers_arm64::getRegisterName(int regNum)
	{
		switch (regNum)
		{
			case UNW_REG_IP:
	...
	bool
	Registers_arm64::validFloatRegister(int regNum) const
	{
	...
	double
	Registers_arm64::getFloatRegister(int regNum) const
	{
		assert(validFloatRegister(regNum));
	...
	void
	Registers_arm64::setFloatRegister(int regNum, double value)
	{
		assert(validFloatRegister(regNum));
	...
	inline bool
	Registers_arm64::validVectorRegister(int regNum) const
	{
		return false;
	}

	inline v128
	Registers_arm64::getVectorRegister(int regNum) const
	{
		ABORT("no arm64 vector register support yet");
	}

	inline void
	Registers_arm64::setVectorRegister(int regNum, v128 value)
	{
		ABORT("no arm64 vector register support yet");
	}
