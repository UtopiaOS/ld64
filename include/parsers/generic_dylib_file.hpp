	...
	namespace dylib
	{
		...
		class ExportAtom final : public ld::Atom
		{
			public:
				...
				virtual uint64_t
				objectAddress() const override final
				{
					return _address;
				}
				virtual void
				copyRawContent(uint8_t buffer[]) const override final { }
		...
		class ImportAtom final : public ld::Atom
		{
			public:
				...
				fixupsBegin() const	override final
				{
					return &_undefs[0];
				}
				virtual ld::Fixup::iterator
				fixupsEnd()	const override final
				{
		...
		class File : public ld::dylib::File
		{
			public:
				...
				virtual uint8_t
				swiftVersion() const override final
				{
					return _swiftVersion;
				}
				virtual ld::Bitcode					*
				getBitcode() const override final
				{
					return _bitcode.get();
				}
				virtual const ld::VersionSet           &
				platforms() const override final
				{
					return _platforms;
				}
				...
				virtual bool
				providedExportAtom() const	override final
				{
					return _providedAtom;
				}
				virtual bool                            hasReExportedDependentsThatProvidedExportAtom() const override;
				virtual const char						*
				parentUmbrella() const override final
				{
					return _parentUmbrella;
				}
				virtual const std::vector<const char *>	*
				allowableClients() const override final
				{
					return _allowableClients.empty() ? nullptr : &_allowableClients;
				}
				virtual const std::vector<const char *>	&
				rpaths() const override final
				{
					return _rpaths;
				}
				virtual bool
				hasWeakExternals() const override final
				{
					return _hasWeakExports;
				}
				virtual bool
				deadStrippable() const override final
				{
					return _deadStrippable;
				}
				...
				virtual bool
				hasPublicInstallName() const override final
				{
					return _hasPublicInstallName;
				}
				virtual bool							allSymbolsAreWeakImported() const override final;
				virtual bool
				installPathVersionSpecific() const override final
				{
					return _installPathOverride;
				}
				virtual bool
				appExtensionSafe() const override final
				{
					return _appExtensionSafe;
				};
				virtual void                            forEachExportedSymbol(void (^handler)(const char *symbolName,
				        bool weakDef)) const override;
				virtual bool
				isUnzipperedTwin() const override
				{
					return _isUnzipperedTwin;
				}
