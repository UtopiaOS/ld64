	...
	namespace passes
	{
		namespace dedup
		{
			...
			struct atom_equal
			{
				...
				static bool
				sameFixups(const ld::Atom *atom1, const ld::Atom *atom2, BackChain &backChain)
				{
					++sFixupCompareCount;
...
#if SUPPORT_ARCH_arm64
							if ((f1->kind != ld::Fixup::kindStoreTargetAddressARM64Branch26)
							        && (f1->kind != ld::Fixup::kindStoreTargetAddressX86BranchPCRel32))
#else
				...
				static bool
				equal(const ld::Atom *atom1, const ld::Atom *atom2, BackChain &backChain)
				{
				...
				bool
				operator()(const ld::Atom *atom1, const ld::Atom *atom2) const
				{
