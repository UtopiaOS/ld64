...
namespace Security
{
	...
	//
	char *
	BlobCore::stringAt(Offset offset)
	{
	...
	const char *
	BlobCore::stringAt(Offset offset) const
	{
	...
	//
	BlobCore *
	BlobCore::readBlob(int fd, size_t offset, uint32_t magic, size_t minSize, size_t maxSize)
	{
		BlobCore header;
	...
	BlobCore *
	BlobCore::readBlob(int fd, uint32_t magic, size_t minSize, size_t maxSize)
	{
		BlobCore header;
	...
	BlobCore *
	BlobCore::readBlob(std::FILE *file, uint32_t magic, size_t minSize, size_t maxSize)
	{
		BlobCore header;
	...
	//
	BlobWrapper *
	BlobWrapper::alloc(size_t length, Magic magic /* = _magic */)
	{
	...
	BlobWrapper *
	BlobWrapper::alloc(const void *data, size_t length, Magic magic /* = _magic */)
	{
